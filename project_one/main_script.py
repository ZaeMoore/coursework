...
# Integral
if whatchadoin == "1":
    radius = float(input("Radius of the charged sphere (m): "))
    rad = round(radius)
    maximum_r = float(input("Maximum radius at which to observe the Electric Field (m): "))
    max_r = round(maximum_r)
    ...
    plt.plot(
        rr_in,
        rE_in,
        label="Riemann Sum inside Sphere",
        color="blue",
        linestyle="dashdot",
        linewidth=3,
    )
    plt.plot(
        rr_out,
        rE_out,
        label="Riemann Sum outside Sphere",
        color="cyan",
        linestyle="dashdot",
        linewidth=3,
    )
    plt.plot(
        tr_in,
        tE_in,
        label="Trapezoidal Sum inside Sphere",
        color="purple",
        linestyle="dashed",
        linewidth=3,
    )
    plt.plot(
        tr_out,
        tE_out,
        label="Trapezoidal Sum outside Sphere",
        color="magenta",
        linestyle="dashed",
        linewidth=3,
    )
    plt.plot(
        sr_in,
        sE_in,
        label="Simpson Sum inside Sphere",
        color="red",
        linestyle="dotted",
        linewidth=3,
    )
    plt.plot(
        sr_out,
        sE_out,
        label="Simpson Sum outside Sphere",
        color="orange",
        linestyle="dotted",
        linewidth=3,
    )
    plt.plot(
        ar_in,
        aE_in,
        label="Analytical Solution inside Sphere",
        color="black",
        linewidth=1,
    )
    plt.plot(
        ar_out,
        aE_out,
        label="Analytical Solution outside Sphere",
        color="black",
        linewidth=1,
    )
    plt.xlabel("r (m)")
...
# ODE
    ...
    t_0 = 0  # Initial time
    initial_temp = float(input("Initial temperature of object (K): "))
    temp_0 = round(initial_temp)
    environment_temp = float(input("Temperature of environment (K): "))
    temp_env = round(environment_temp)
    time = t_0
    ...
    plt.figure(1)
    plt.plot(
        t_list, temp_eu, label="Euler", color="blue", linestyle="dashed", linewidth=3
    )
    plt.plot(
        t_list,
        temp_rk,
